...
namespace RestWithASPNETUdemy.Hypermedia.Utils
{
    ...
    public class PagedSearchVO<T> where T : ISupportsHyperMedia
    {
        ...
        public PagedSearchVO(int currentPage, int page, string sortFields, string sortDirections)
        {
        ...
        public PagedSearchVO(int currentPage, int page, string sortFields, string sortDirections, Dictionary<string, object> filters)
        {
            CurrentPage = currentPage;
            PageSize = page;
            SortFields = sortFields;
